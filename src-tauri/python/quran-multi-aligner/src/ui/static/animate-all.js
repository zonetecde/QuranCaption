...
function stopAnimateAll() {
    ...
    document.querySelectorAll('.split-group.hidden-for-mega, .missing-words-group.hidden-for-mega').forEach(function(g) {
...
function toggleAnimateAll(btn) {
    ...
    document.querySelectorAll('.segments-container .split-group, .segments-container .missing-words-group').forEach(function(g) {
