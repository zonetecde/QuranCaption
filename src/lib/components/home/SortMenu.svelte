<script lang="ts">
	...
	import type { HomeSortProperty } from '$lib/classes/Settings.svelte';
...
{#if isVisible}
	<div
		class="sort-menu absolute top-full end-0 mt-2 w-[370px] bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg shadow-xl z-50 p-4"
