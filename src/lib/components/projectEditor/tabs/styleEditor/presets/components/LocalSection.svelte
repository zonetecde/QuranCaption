...
<section class="space-y-3">
	<button
		class="flex min-h-11 w-full items-center gap-3 rounded-lg border border-color bg-primary/40 px-3 py-2 text-left"
		type="button"
	...
	>
		...
		<span class="material-icons-outlined text-lg text-secondary">
