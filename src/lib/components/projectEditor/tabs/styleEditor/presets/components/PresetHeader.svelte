<script lang="ts">
	...
	import { closePublishForm } from '../actions/publishActions';
...
<div class="flex min-w-0 items-center gap-2 border-b border-color px-3 py-2.5">
	<button
	...
	<h2 class="min-w-0 flex-1 truncate text-base font-semibold text-primary">
