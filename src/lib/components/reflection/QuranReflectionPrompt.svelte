		...
		>
			...
			<div class="reflection-content min-h-0 flex-1 space-y-3 overflow-y-auto p-4">
				...
				{:else if stage === 'success'}
					<div class="rounded-xl px-5 py-6 text-center">
						...
						<div class="mt-5 flex flex-col items-center justify-center gap-2.5">
							{#if successUrl}
								<button
									type="button"
									class="reflection-primary inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl px-5 text-sm font-semibold"
							...
							<button
								type="button"
								class="reflection-auth-back min-h-11 w-full rounded-xl px-5 text-sm font-semibold text-secondary"
