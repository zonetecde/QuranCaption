<script lang="ts">
	...
	const TOUR_STEPS: TourStep[] = [
		...
		// ── VIDEO EDITOR ────────────────────────────────────────────────────────
		{
			...
			description:
				'Here you import your Quran recitation. Three options: <strong>Add Asset</strong> (local file), <strong>Download from MP3Quran</strong>, or <strong>Download from YouTube</strong>. The tutorial project already has an audio asset ready for you.',
			advanceMode: 'button',
			buttonLabel: 'Next'
		},
		{
