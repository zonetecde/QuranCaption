const editor = {
	...
	importFontFromFile: 'Import from file',
	fontFiles: 'Font files',
	fontImportError: 'This font file could not be imported.',
	...
	controlHelpPreset: 'Insert silence, basmala, or another preset',
	controlHelpAi: 'Let AI generate the subtitles',
	controlHelpPreviousVerse: 'Go to the previous verse',
	controlHelpNextVerse: 'Go to the next verse',
	firstVideoGuide: 'Your first video',
	guideStep: 'Step {current} of {total}',
	guideMedia: 'Add the recitation and place your media on the timeline.',
	guideSubtitles: 'Create and align the Quran subtitles with the recitation.',
	guideTranslations: 'Optionally add and adapt a translation to each recited passage.',
	guideStyle: 'Choose a preset, then customize the visual result if needed.',
	guideExport: 'Check that the project is ready, then export the final video.',
	optional: 'Optional',
	hideGuide: 'Hide the first video guide',
	showGuideAgainQuestion: 'Show the “Your first video” guide again for future projects?',
	nextStep: 'Next: {step}',
	...
	manualSubtitleSteps: '1. Play the audio → 2. Select the recited words → 3. Tap the checkmark',
	viewExample: 'Watch an example',
	controlsGuide: 'Controls guide',
	translationGuideTitle: 'Adapt the translation to the recited passage',
	translationGuideDescription:
		'Tap or drag over the translated words to keep only the part that matches the Arabic subtitle.',
	reviewProgress: '{progress}% reviewed',
	styleGuideTitle: 'Start with a ready-made style',
	styleGuideDescription:
		'Apply a preset first, check the preview, then customize individual settings if needed.',
	customizeStyles: 'Customize manually',
	volumeLabel: 'Volume',
	...
	alignmentSettingsDesc: 'Choose recognition, Quran reading, and segment boundaries.',
	segmentBoundaries: 'Segment boundaries',
	startEarlier: 'Start earlier',
	endLater: 'End later',
	timelineBehavior: 'Timeline',
	timelineBehaviorDesc: 'Choose how aligned results are added to the timeline.',
	keepSilentGaps: 'Keep silent gaps',
	keepSubtitlesVisible: 'Keep subtitles visible between segments',
	extendIntoSilence: 'Extend the previous subtitle into silence by',
	modelLabel: 'Model',
	deviceLabel: 'Device',
	...
	alignmentStage: {
		...
		queued_gpu: 'Waiting for GPU',
		queued_cpu: 'Waiting for CPU',
		segmenting: 'Finding recitation boundaries',
		transcribing: 'Transcribing recitation',
		matching: 'Matching Quran verses',
		building: 'Building results',
		splitting: 'Creating one subtitle per verse',
	...
	computeTimestamps: 'Compute timestamps',
	wbwTimestampsComputed: 'WBW timestamps computed for {enriched}/{total} subtitle{plural}.',
	...
	reviewTranslationsWithAi: 'Review translations with AI',
	...
	runAiTranslationReview: 'Review all translations',
	runningAiTranslationReview: 'Reviewing translations...',
	aiTranslationReviewComplete: 'AI reviewed {checked} translations and marked {marked} for review.',
	aiTranslationReviewFailed: 'AI translation review failed: {error}',
	aiTranslationReviewNoTranslations: 'No project translations are available to review.',
	...
	styleName: {
		...
		'enable-wbw-line-background': 'Enable WBW line background',
		'wbw-line-background-color': 'WBW bar color',
		'wbw-line-background-position': 'WBW bar position',
		'wbw-line-background-height': 'WBW bar height',
		'wbw-line-background-padding': 'WBW horizontal padding',
		...
		'line-background-enable': 'Enable Line Background',
		...
		'media-fill': 'Fill Frame',
		'media-scale': 'Zoom',
		'media-position-x': 'Horizontal Position',
		'media-position-y': 'Vertical Position',
		...
		'background-overlay-fade-softness': 'Fade Softness',
		'background-overlay-fade-curve': 'Fade Curve',
		'background-overlay-fade-invert': 'Invert Fade',
		'background-overlay-fade-position-x': 'Fade Horizontal Position',
		'background-overlay-fade-position-y': 'Fade Vertical Position',
		'background-overlay-fade-width': 'Fade Width',
		'background-overlay-fade-height': 'Fade Height',
		uniform: 'Uniform',
		'fade-up': 'Fade Up',
		'fade-down': 'Fade Down',
		'fade-center': 'Center Fade',
		'fade-left': 'Left Fade',
		'fade-right': 'Right Fade',
		'fade-left-right': 'Left & Right Fade',
		'fade-top-bottom': 'Top & Bottom Fade',
		'fade-four-corners': 'Four-Corner Fade',
		'fade-four-sides': 'Four-Side Fade',
		'fade-vignette': 'Vignette',
		'fade-top-left': 'Top-Left Corner Fade',
		'fade-top-right': 'Top-Right Corner Fade',
		'fade-bottom-left': 'Bottom-Left Corner Fade',
		'fade-bottom-right': 'Bottom-Right Corner Fade',
		linear: 'Linear',
		'ease-in': 'Ease In',
		'ease-out': 'Ease Out',
		smooth: 'Smooth',
		...
		'video-frame-radius': 'Corner Roundness',
		'video-frame-softness': 'Edge Softness',
		...
		'surah-calligraphy-style': 'Calligraphy Style',
		'surah-size': 'Size',
	...
	styleDescription: {
		...
		'enable-wbw-line-background': 'Highlight recited words with the rounded line background style',
		'wbw-line-background-color': 'Color applied to the line background of highlighted words',
		...
		'wbw-line-background-padding': 'Add equal horizontal spacing to both ends of the WBW bar',
		...
		'line-background': 'Add a rounded background bar behind each subtitle line',
		'line-background-enable': 'Enable or disable the background bar behind each subtitle line',
		...
		'background-overlay-mode': 'Choose the direction or shape of the overlay fade',
		'background-overlay-fade-intensity': 'Controls fade strength when overlay mode is not uniform',
		'background-overlay-fade-coverage': 'Controls how much of the overlay is occupied by the fade',
		...
		'background-overlay-fade-invert': 'Swap the strong and light areas of the fade',
		'background-overlay-fade-position-x': 'Move the center of the fade horizontally',
		'background-overlay-fade-position-y': 'Move the center of the fade vertically',
		'background-overlay-fade-width': 'Control the horizontal size of radial and corner fades',
		...
		'video-frame-radius': 'Round the inner corners of the video frame as a percentage',
		'video-frame-softness': 'Soften the inner edge of the video frame as a percentage',
