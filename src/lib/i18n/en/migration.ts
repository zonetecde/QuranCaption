const migration = {
	...
	translationsDesc: 'Your selected translation editions',
	styleLimitations: 'Style limitations',
	styleLimitationsDesc: 'Video styles will be reset to default settings',
	customTexts: 'Custom texts',
	customTextsDesc: 'Will be replaced with silence clips',
