const tools = {
	...
	selectAyahRangeDescription: 'Keep only a selected range of Quran Ayahs',
	ayahsAvailable: ' Ayahs',
	selectAyahRangeHint: 'Choose the first and last Ayah to keep.',
	cropToAyahRange: 'Crop to Ayah Range',
	...
	noQuranSubtitlesToCrop: 'No Quran subtitles are available to crop.',
	noAyahRangeSelected: 'Select at least one Ayah to keep.',
	ayahRangeCropSuccess: 'Project cropped to the selected Ayah range.',
