...
const fr = {
	...
	batch: {
		...
		batchNamePlaceholder: 'Récitations du Ramadan',
		importTitle: 'Importer un batch',
		importDescription: 'Validez un fichier CSV avant de créer ses projets Quran Caption.',
		backToHome: 'Retour à l’accueil',
		csvFile: 'Fichier CSV',
		selectCsv: 'Sélectionner un CSV',
		readingCsv: 'Lecture du CSV...',
		noCsvSelected: 'Aucun fichier CSV sélectionné',
		csvFormatHelp:
			'Colonnes attendues : project_name;reciter;source;filepath_segmentation (facultative)',
		...
		urlSource: 'URL',
		localFileSource: 'Fichier local',
		valid: 'Valide',
		invalid: 'Invalide',
		validationErrors: 'Erreurs de validation',
		lineError: 'Ligne {line} : {message}',
		projectsCount: '{count} projet(s)',
		multipleReciters: 'Plusieurs récitateurs',
		mediaImported: '{completed} / {total} média(s) importé(s)',
		updated: 'Modifié le {date}',
		createBatch: 'Créer le batch',
		creatingBatch: 'Création du batch...',
		readFailed: 'Impossible de lire le fichier CSV : {error}',
		templateSaveFailed: 'Impossible d’enregistrer le modèle CSV : {error}',
		createFailed: 'Impossible de créer le batch : {error}',
		errorBatchNameEmpty: 'Le nom du batch ne peut pas être vide.',
		errorBatchNameTooLong: 'Le nom du batch est trop long.',
		errorBatchNameUnsafe: 'Le nom du batch contient un caractère interdit.',
		errorInvalidHeader:
			'les en-têtes attendus sont project_name, reciter, source et éventuellement filepath_segmentation.',
		errorMissingColumn: 'une ou plusieurs colonnes sont manquantes.',
		errorTooManyColumns: 'la ligne contient trop de colonnes non vides.',
		errorMalformedCsv: 'le champ CSV entre guillemets est incorrect.',
		errorProjectNameEmpty: 'le nom du projet est vide.',
		errorReciterEmpty: 'le récitateur est vide.',
		errorSourceEmpty: 'la source est vide.',
		errorProjectNameTooLong: 'le nom du projet est trop long.',
		errorReciterTooLong: 'le nom du récitateur est trop long.',
		errorProjectNameUnsafe: 'le nom du projet contient un caractère interdit.',
		errorReciterUnsafe: 'le récitateur contient un caractère interdit.',
		errorInvalidUrl: 'l’URL HTTP(S) est invalide.',
		errorFileNotFound: 'le fichier local est introuvable.',
		errorUnsupportedMedia: 'le format du fichier local n’est pas pris en charge.',
		errorSegmentationJsonFileNotFound: 'le fichier JSON de segmentation IA est introuvable.',
		errorInvalidSegmentationJson:
			'le fichier de segmentation IA n’est pas un JSON valide pris en charge.',
		noBatchSelected: 'Aucun batch n’est sélectionné.',
		loadFailed: 'Impossible de charger le batch : {error}',
		loadingBatch: 'Chargement du batch...',
		media: 'Média',
		actions: 'Actions',
		...
		segmentationProcessing: 'En cours',
		segmentationAutoVerified: 'Vérifié automatiquement',
		segmentationNeedsReview: 'À vérifier',
		segmentationManuallyVerified: 'Vérifié manuellement',
		segmentationFailed: 'Échec',
		segmentationApplying: 'Application des segments',
		segmentationSaving: 'Sauvegarde du projet',
		segmentationManualBlocked: 'Une segmentation Batch est en cours.',
		segmentationAlreadyRunning: 'Une autre segmentation est déjà en cours.',
		segmentationInterrupted: 'La segmentation a été interrompue avant sa fin.',
		segmentationQueueSummary:
			'{active} actif · {completed} terminés · {needsReview} à vérifier · {failed} en échec · {remaining} restants',
		segmentationCompletedTitle: 'Segmentation Batch terminée',
		segmentationCompletedBody:
			'{completed} vérifiés automatiquement · {needsReview} à vérifier · {failed} en échec',
		readyForTranslations: 'Prêts pour les traductions : {ready} / {total}',
		reviewFlaggedProjects: 'Vérifier les projets signalés',
		reviewProject: 'Vérifier',
		reviewPreviousProject: 'Projet signalé précédent',
		reviewNextProject: 'Projet signalé suivant',
		reviewDeleteProject: 'Supprimer le projet actuel',
		reviewDeleteProjectConfirm: 'Supprimer définitivement le projet actuel de ce batch ?',
		reviewUnableToDeleteProject: 'Impossible de supprimer le projet actuel.',
		reviewBackToBatch: 'Retour au batch',
		reviewingProject: 'Vérification du projet {current} sur {total}',
		reviewCompleted: 'Tous les projets signalés ont été vérifiés.',
		reviewUnableToLoadProject: 'Impossible de charger le projet suivant.',
		reviewSessionInvalid: "La session de vérification du batch n'est plus valide.",
		segmentationSegments: '{count} segment(s)',
		segmentationIssues: '{count} problème(s)',
		segmentationCoverageCount: '{count} couverture',
		segmentationLowConfidenceCount: '{count} faible confiance',
		segmentationReviewTooltip:
			'{coverage} couverture · {lowConfidence} faible confiance · {long} longs · {wbw} timestamps WBW',
		segmentationInspecting: 'Vérification des projets et du moteur de segmentation…',
		segmentationSelectedCount: '{count} projet(s) sélectionné(s)',
		segmentationEligibleCount: '{count} projet(s) éligible(s)',
		segmentationRuntime: 'Moteur : {value}',
		segmentationRuntimeLocal: 'Local',
		segmentationRuntimeCloud: 'Cloud',
		segmentationModel: 'Modèle : {value}',
		segmentationDevice: 'Appareil : {value}',
		notApplicable: 'Non applicable',
		segmentationWbw: 'Timestamps mot à mot : {value}',
		enabled: 'Activés',
		disabled: 'Désactivés',
		segmentationMinSilence: 'Silence minimum : {value} ms',
		segmentationMinSpeech: 'Parole minimum : {value} ms',
		segmentationPadding: 'Marge : {value} ms',
		segmentationFillSilence: 'Les intervalles sont remplis par des clips de silence.',
		segmentationFillExtend: 'Les sous-titres sont étendus pour remplir les intervalles.',
		...
		segmentationErrorLOCAL_ENGINE_UNAVAILABLE:
			'Le moteur local choisi est indisponible. Configurez-le dans la fenêtre Segmentation IA normale.',
		segmentationErrorHF_TOKEN_REQUIRED:
			'Le moteur choisi exige un token Hugging Face. Configurez-le dans la fenêtre Segmentation IA normale.',
		...
		segmentationReasonSEGMENTATION_IN_PROGRESS: 'La segmentation est déjà en attente ou en cours',
		segmentationReasonALREADY_VALIDATED: 'La segmentation est déjà validée',
		segmentationReasonAUDIO_TRACK_EMPTY: 'La piste audio est vide',
		segmentationReasonAUDIO_FILE_MISSING: 'Un fichier audio est manquant',
		segmentationReasonEXISTING_SUBTITLES:
			'Les sous-titres existants exigent un remplacement explicite',
		startSegmentation: 'Lancer la segmentation',
		...
		addTranslationsToProjects: 'Ajouter des traductions aux projets',
		fetchTranslationsFromProjects: 'Récupérer les traductions des autres projets',
		translationEdition: 'Édition de traduction :',
		translations: 'Traductions',
		translationNotAdded: 'Non ajoutée',
		translationAdding: 'Ajout des traductions',
		translationReadyToFetch: 'Prête à récupérer',
		translationFetching: 'Récupération des traductions',
		translationAutoVerified: 'Traductions vérifiées automatiquement',
		translationNeedsReview: 'Traductions à vérifier',
		translationManuallyVerified: 'Vérifiée manuellement',
		translationFailed: 'Échec',
		translationQueueSummary: '{completed} / {total} projet(s) traité(s)',
		translationCounts: '{complete}/{total} complètes · {pending} restantes · {fetched} récupérées',
		translationSelectedProjects: 'Projets sélectionnés : {count}',
		translationEligibleProjects: 'Projets éligibles : {count}',
		translationInspectingProjects: 'Inspection des projets sélectionnés…',
		translationIgnoredProjects: 'Projets ignorés',
		translationReasonSegmentation: 'La segmentation n’est pas vérifiée',
		translationReasonSubtitles: 'La piste de sous-titres est vide',
		translationReasonProject: 'Projet introuvable ou illisible',
		translationSearchEditions: 'Rechercher par langue ou auteur…',
		translationAlreadyAddedCount: 'Édition déjà ajoutée dans {count} projet(s) sélectionné(s).',
		translationSkipExisting: 'Ignorer les projets qui contiennent déjà cette édition',
		translationReplaceWarning:
			'Les traductions existantes seront remplacées dans les projets concernés.',
		translationAdd: 'Ajouter',
		translationFetch: 'Récupérer',
		translationPendingCount: 'Traductions incomplètes : {count}',
		translationMissingEditionCount: 'Projets sans cette édition : {count}',
		reviewTranslationProjects: 'Vérifier les traductions signalées',
		translationReviewCompleted: 'Toutes les traductions de cette édition ont été vérifiées.',
		translationInterrupted: 'Opération de traduction interrompue',
		selectTranslationEdition: 'Sélectionner une édition',
		noCommonTranslationEdition: 'Aucune édition commune trouvée',
		globalActions: 'Actions globales',
		setBackground: 'Définir le fond',
		setBackgroundForSelectedProjects: 'Définir le fond des projets sélectionnés',
		setBackgroundScope: 'Remplacer la piste vidéo des {count} projet(s) sélectionné(s).',
		chooseBackgroundImage: 'Choisir une image',
		chooseBackgroundVideo: 'Choisir une vidéo',
		backgroundImage: 'Image de fond',
		backgroundVideo: 'Vidéo de fond',
		backgroundInvalidFile: 'Le fichier de fond sélectionné est invalide.',
		backgroundSet: 'Fond défini pour tous les projets sélectionnés.',
		backgroundSetWithFailures: 'Remplacement du fond terminé avec {failed} échec(s).',
		applyStyle: 'Appliquer un style',
		applyStyleToAllProjects: 'Appliquer un style à tous les projets',
		applyStyleToSelectedProjects: 'Appliquer un style aux projets sélectionnés',
		selectSavedPreset: 'Sélectionner un preset sauvegardé',
		noSavedPresets: 'Aucun preset sauvegardé n’est disponible.',
		styleAllProjectsScope: 'Cette action modifiera les {count} projets du batch.',
		styleSelectedProjectsScope: 'Cette action modifiera les {count} projet(s) sélectionné(s).',
		existingStylesReplaced: 'Les styles existants seront remplacés par le preset sélectionné.',
		applyingStyleProgress:
			'Application du style : {completed} / {total} terminés · {failed} en échec',
		styleApplied: 'Style appliqué à tous les projets sélectionnés.',
		styleAppliedWithFailures: 'Application du style terminée avec {failed} échec(s).',
		exportAll: 'Tout exporter',
		exportAllProjects: 'Exporter tous les projets',
		anotherBatchOperationActive: 'Une autre opération Batch modifie les projets.',
		exportCurrentlyRunning: 'Un export est actuellement en cours.',
		usingEachProjectSavedSettings:
			'Utilisation des réglages d’export sauvegardés de chaque projet.',
		inspectingExportProjects: 'Inspection des projets avant export…',
		readyToExport: 'Prêts à exporter : {count}',
		notReadyToExport: 'Non prêts à exporter : {count}',
		selectOutputFolder: 'Sélectionner le dossier de sortie',
		exportReadyProjects: 'Exporter les {count} projet(s) prêts',
		exportSelectedProjects: 'Exporter {count} projet(s)',
		exportNonReadyProjects: 'Inclure les projets non prêts',
		exportNonReadyWarning:
			'Ils seront tout de même mis en file d’attente et pourront échouer. Les projets introuvables ou déjà en cours d’export restent exclus.',
		exportReasonPROJECT_MISSING: 'Projet introuvable',
		exportReasonMEDIA_NOT_READY: 'Média absent',
		exportReasonAUDIO_TRACK_EMPTY: 'La piste audio est vide',
		exportReasonINVALID_DURATION: 'La durée du média est invalide',
		exportReasonSUBTITLES_MISSING: 'Les sous-titres sont absents',
		exportReasonEXPORT_ACTIVE: 'Un export est déjà actif',
		exportReasonASSET_MISSING: 'Un fichier asset média est introuvable',
		exportReasonEXPORT_SETTINGS_INVALID: 'La configuration d’export sauvegardée est invalide',
		exportingProjectsProgress:
			'Export des projets : {completed} / {total} terminés · {failed} en échec',
		currentExportProject: 'Projet actuel : {project}',
		allEligibleProjectsExported: 'Tous les projets éligibles ont été exportés.',
	...
	editor: {
		...
		selectFromFile: 'Choisir un fichier',
		fileLabel: 'Fichier',
		quaShortLabel: 'QUA',
		...
		controlHelpPreset: 'Insérer un silence, basmala, ou autre',
		controlHelpAi: 'Laisser l’IA générer les sous-titres',
		controlHelpPreviousVerse: 'Aller au verset précédent',
		controlHelpNextVerse: 'Aller au prochain verset',
		...
		manualSubtitleSteps:
			'1. Lancez l’audio → 2. Sélectionnez les mots récités → 3. Touchez la coche',
		...
		translationGuideDescription:
			'Touchez ou faites glisser les mots traduits pour ne conserver que la partie correspondant au sous-titre arabe.',
		...
		downloadFromSocialMedia: 'Réseaux sociaux',
		...
		fileImportHint:
			'Importez une récitation coranique, une vidéo d’arrière-plan ou tout autre fichier audio, vidéo ou image utile à votre projet.',
		...
		howItWorksDescription2:
			'Gras, italique, souligné et nouvelle ligne sont basculés sur la plage sélectionnée. La couleur et la lueur sont appliquées avec leurs échantillons actuels. Modifier le texte de la traduction supprime les styles de mots de la traduction.',
		...
		styleName: {
			...
			'wbw-keep-specific-word-style': 'Conserver le style du mot après sa révélation',
			...
			'line-background': 'Fond par ligne',
			'line-background-enable': 'Activer le fond par ligne',
			...
			'background-overlay-fade-softness': 'Douceur du fondu',
			'background-overlay-fade-curve': 'Courbe du fondu',
			'background-overlay-fade-invert': 'Inverser le fondu',
			'background-overlay-fade-position-x': 'Position horizontale du fondu',
			'background-overlay-fade-position-y': 'Position verticale du fondu',
			'background-overlay-fade-width': 'Largeur du fondu',
			'background-overlay-fade-height': 'Hauteur du fondu',
			uniform: 'Uniforme',
			'fade-up': 'Fondu vers le haut',
			'fade-down': 'Fondu vers le bas',
			'fade-center': 'Fondu central',
			'fade-left': 'Fondu à gauche',
			'fade-right': 'Fondu à droite',
			'fade-left-right': 'Fondu à gauche et à droite',
			'fade-top-bottom': 'Fondu en haut et en bas',
			'fade-four-corners': 'Fondu aux quatre coins',
			'fade-four-sides': 'Fondu sur les quatre côtés',
			'fade-vignette': 'Vignette',
			'fade-top-left': 'Fondu au coin supérieur gauche',
			'fade-top-right': 'Fondu au coin supérieur droit',
			'fade-bottom-left': 'Fondu au coin inférieur gauche',
			'fade-bottom-right': 'Fondu au coin inférieur droit',
			linear: 'Linéaire',
		...
		styleDescription: {
			...
			'wbw-keep-specific-word-style':
				'Conserver les styles personnalisés visibles après la récitation des mots associés',
			...
			'line-background': 'Ajouter une barre de fond arrondie derrière chaque ligne de sous-titre',
			'line-background-enable': 'Activer ou désactiver la barre derrière chaque ligne',
			...
			'overlay-opacity': 'Opacité de la superposition',
			'background-overlay-mode': 'Choisir la direction ou la forme du fondu de superposition',
			...
			'background-overlay-fade-coverage':
				'Contrôle la part de la superposition occupée par le fondu',
			'background-overlay-fade-softness':
				'Contrôle la progressivité de la transition entre les zones légères et fortes',
			'background-overlay-fade-curve':
				'Choisir la progression de l\u2019opacité pendant la transition',
			'background-overlay-fade-invert': 'Échanger les zones fortes et légères du fondu',
			'background-overlay-fade-position-x': 'Déplacer horizontalement le centre du fondu',
			'background-overlay-fade-position-y': 'Déplacer verticalement le centre du fondu',
			'background-overlay-fade-width':
				'Contrôler la taille horizontale des fondus radiaux et de coins',
			'background-overlay-fade-height':
				'Contrôler la taille verticale des fondus radiaux et de coins',
	...
	export: {
		reflectionTitle: 'Réfléchissez à ce que vous venez de créer',
		reflectionDescription:
			'Vous venez de passer du temps avec ces versets. Prenez un moment pour réfléchir à ce qu’ils représentent pour vous.',
		reflectionDismiss: 'Pas maintenant',
		reflectionOn: 'Réfléchir sur',
		...
		reflectionExamplesTitle: 'Réflexions d’autres musulmans',
		reflectionExamplesLoading: 'Recherche de réflexions liées…',
		reflectionExamplesError:
			'Impossible de charger les réflexions liées. Veuillez réessayer dans un instant.',
		reflectionViewExamples: 'Voir les réflexions liées',
		reflectionHideExamples: 'Masquer les réflexions liées',
		reflectionNoExamples: 'Aucune réflexion liée n’est encore disponible pour cette sélection.',
		...
		reflectionPrivateDescription: 'Enregistrer comme note privée sur Quran.com',
		reflectionPublic: 'Publier publiquement',
		reflectionPublicDescription: 'Publier sur QuranReflect',
		reflectionAuthTitle: 'Se connecter avec Quran.com',
		reflectionAuthDescription:
			'Un compte Quran.com est requis uniquement pour enregistrer ou publier votre réflexion.',
		reflectionPermissionDescription:
			'Quran Caption a besoin d’une autorisation Quran.com supplémentaire pour les notes et QuranReflect.',
		reflectionConnect: 'Se connecter avec Quran.com',
		...
		exportReadiness: 'Préparation de l’export',
		mediaReadyForExport: 'Un média est présent sur la timeline',
		mediaMissingForExport: 'Ajoutez un audio ou une vidéo à la timeline avant l’export',
		subtitlesReadyForExport: '{count} sous-titre(s) prêt(s)',
		subtitlesMissingForExport: 'Ajoutez au moins un sous-titre avant l’export',
		readyToExport: 'Prêt',
		...
		meaningRangeMode: 'Par sens',
		meaningRangeDescription:
			'Envoie les versets de votre vidéo à l’IA pour créer des plages d’export sémantiques distinctes.',
		maxDuration: 'Durée maximale (secondes)',
		maxDurationDescription: 'Durée cible maximale de chaque plage vidéo générée.',
		...
		noMeaningVerses: 'Aucun verset coranique n’est disponible dans cette vidéo.',
		meaningRangesGenerationFailed: 'Les plages par sens n’ont pas pu être générées.',
		...
		startTime: 'Début',
		endTime: 'Fin',
		addSkip: 'Ajouter une coupure',
		skip: 'Coupure',
		setSkipStartToCursor: 'Début au curseur',
		setSkipEndToCursor: 'Fin au curseur',
		...
		exportOnlyRecitation: 'Exporter uniquement la récitation',
		exportOnlyRecitationDescription:
			'Exporte la récitation en conservant la basmala, l\u2019istiʿādha et « Amîn », tout en ignorant les takbirs, le taslim, les autres passages non coraniques et les longs silences.',
		recitationContent: 'Contenu de la récitation',
		recitationCutMargin: 'Marge de coupe (ms)',
		recitationCutMarginDescription:
			'Conserve cette durée audio avant et après chaque coupure de récitation.',
		recitationMinimumSilence: 'Silence minimum pour une coupe (ms)',
		recitationMinimumSilenceDescription: 'Les pauses naturelles plus courtes sont conservées.',
		noRecitationInExportRange:
			'Aucune récitation du Coran n\u2019a été trouvée dans la plage d\u2019export sélectionnée.',
		noContentAfterSkips:
		...
		parallelCaptureWorkersDescription:
			'Modification déconseillée sur téléphone : utiliser plus d’un renderer ralentit souvent l’export, car les renderers se partagent le processeur et la mémoire. Valeur par défaut : 1 ; maximum : 4.',
		...
		youtubeChaptersOption: 'Chapitres YT',
		...
		chapterPerHizb: 'Chapitre par hizb',
		chapterPerHizbDescription: 'Crée un chapitre pour chaque hizb dans votre timeline vidéo.',
		chapterPerJuz: 'Chapitre par juz',
		chapterPerJuzDescription: 'Crée un chapitre pour chaque juz dans votre timeline vidéo.',
		chapterPerRub: 'Chapitre par rubʿ',
		chapterPerRubDescription: 'Crée un chapitre pour chaque rubʿ dans votre timeline vidéo.',
		chapterFormatSuggestion: 'Vous voudrez peut-être modifier le format du texte en « {format} »',
		...
		exportProjectDataDescription:
			'Exportez la configuration de votre projet dans un fichier JSON autonome, sans ses fichiers média.',
		includeProjectAssets: 'Inclure les assets du projet',
		includeProjectAssetsDescription:
			'Regrouper vos fichiers audio, vidéo, image et autres assets locaux du projet dans un fichier .qc.',
		exportProjectPackage: 'Exporter le paquet du projet',
		exportProjectPackageDescription:
			'Exportez la configuration et les assets de votre projet dans un paquet .qc.',
		...
		projectAssets: 'Assets du projet',
		projectAssetsDescription:
			'Fichiers audio, vidéo, image et autres assets locaux utilisés par ce projet.',
		limitations: 'Limitations',
		mediaFilesNotIncluded: 'Fichiers média non inclus',
		mediaFilesNotIncludedDescription:
			'Les fichiers audio, vidéo, image et autres fichiers importés depuis votre appareil ne sont pas inclus. Seuls les noms de fichiers et les URL sources sont conservés.',
		projectAssetsIncluded: 'Assets du projet inclus',
		projectAssetsIncludedDescription:
			'Le paquet .qc contient la configuration de votre projet et ses assets locaux.',
		...
		exportProjectPackageButtonDescription:
			'Générer un fichier .qc contenant tout votre projet et ses assets',
	...
	settings: {
		...
		aiKey: 'Clé IA',
		apiKeys: 'Clés API',
		huggingFaceAccount: 'Compte Hugging Face',
		huggingFaceQuotaDescription:
			'Fournissez un token de votre compte Hugging Face gratuit pour augmenter votre quota GPU quotidien.',
		huggingFaceTokenPlaceholder: 'hf_...',
		huggingFaceConfigured: 'Token configuré',
		huggingFaceNotConfigured: 'Token non configuré',
		...
		huggingFaceTokenGuide: 'Comment créer un token',
		huggingFaceValidationFailed: 'Impossible de vérifier le compte Hugging Face.',
		stockMedia: 'Stock',
		...
		categoryCannotBeEmpty: 'La catégorie ne peut pas être vide.',
		categoryAlreadyExists: 'Cette catégorie existe déjà.',
		categoryInvalidCharacters: 'La catégorie contient des caractères non autorisés.',
		...
		defaultYouTubeMetadata: 'Métadonnées YouTube par défaut',
		defaultYouTubeMetadataDescription:
			'Préremplissez les envois YouTube. Laissez le titre vide pour utiliser le nom du fichier exporté.',
		defaultYouTubeTitle: 'Titre de vidéo par défaut',
		defaultYouTubeDescription: 'Description de vidéo par défaut',
		...
		backupDescription:
			'Exportez tous les projets dans un seul fichier de sauvegarde, ou importez une sauvegarde complète ultérieurement. Vos données sont toujours stockées localement sur votre machine.',
		...
		importBackupDescription:
			'Chargez tous les projets depuis un fichier JSON de sauvegarde. Les nouveaux éléments seront ajoutés sans supprimer les existants.',
	...
	tour: {
		...
		stepOpenTutorialTitle: 'Créer votre projet',
		stepOpenTutorialDesc:
			'Donnez un nom au projet, choisissez facultativement son récitateur, puis touchez Créer le projet. Vous apprendrez chaque étape avec ce projet vide.',
		stepVideoEditorTitle: 'Les médias du projet',
		stepVideoEditorDesc:
			'La zone Éléments contient les fichiers utilisés par le projet. Touchez Ajouter un élément pour importer un fichier ou télécharger une récitation.',
		stepAddToTimelineTitle: 'Ajouter à la timeline',
		stepAddToTimelineDesc:
			'Touchez le bouton + de l\u2019élément de récitation pour l\u2019ajouter à la piste audio de la timeline.',
		...
		stepManualSegmentationDesc:
			'Choisissez la sourate et le verset, sélectionnez les mots récités, puis touchez la coche pour créer un sous-titre à la position de lecture actuelle.',
		stepShortcutsTitle: 'Commandes et visite guidée',
		stepShortcutsDesc:
			'Touchez l\u2019icône ? pour voir les commandes disponibles. Elles accélèrent considérablement la segmentation manuelle.',
		stepAutoSegmentTitle: 'Sous-titres IA',
		stepAutoSegmentDesc:
			'Touchez IA Subtitles pour laisser l\u2019IA identifier les versets récités et créer leurs minutages à partir de l\u2019audio.',
		...
		stepExportVideoDesc:
			'Définissez ici les temps de début et de fin, puis ajoutez éventuellement des passages à ignorer. Vérifiez ensuite la qualité plus bas et touchez Exporter.',
		hintClickTutorialCard: 'Touchez Nouveau projet pour continuer',
		hintHoverAndAdd: 'Saisissez un nom, puis touchez Créer le projet pour continuer',
		hintClickSubtitlesTab:
			'Touchez l\u2019onglet \u00ab\u00a0Sous-titres\u00a0\u00bb pour continuer',
		hintClickTranslationsTab:
			'Touchez l\u2019onglet \u00ab\u00a0Traductions\u00a0\u00bb pour continuer',
		hintClickStyleTab: 'Touchez l\u2019onglet \u00ab\u00a0Style\u00a0\u00bb pour continuer',
		hintClickExportTab: 'Touchez l\u2019onglet \u00ab\u00a0Export\u00a0\u00bb pour continuer',
	...
	tools: {
		...
		selectAyahRange: 'Sélectionner une plage de versets',
		selectAyahRangeDescription: 'Ne conserver qu’une plage sélectionnée de versets du Coran',
		ayahsAvailable: ' versets',
		selectAyahRangeHint: 'Choisissez le premier et le dernier verset à conserver.',
		cropToAyahRange: 'Rogner à la plage de versets',
		cropToAyahRangeConfirm:
			'L’audio et la vidéo seront rognés à {range}. Les sous-titres et les éléments de la timeline hors de cette plage seront supprimés. Continuer\u00a0?',
		noQuranSubtitlesToCrop: 'Aucun sous-titre coranique n’est disponible pour le rognage.',
		noAyahRangeSelected: 'Sélectionnez au moins un verset à conserver.',
		ayahRangeCropSuccess: 'Le projet a été rogné à la plage de versets sélectionnée.',
		assetTrimmer: 'Rogner un élément',
	...
	exporterMonitor: {
		...
		stateProcessingBackground: 'Préparation du fond',
		...
		youtubeRetry: 'Réessayer l\u2019envoi YouTube',
		youtubeConnectedAccount: 'Compte YouTube connecté',
		youtubeDisconnect: 'Déconnecter',
		youtubeConnecting: 'Connexion…',
		youtubeConnect: 'Connecter un compte YouTube',
		youtubeTitle: 'Titre',
		youtubeDescription: 'Description',
		youtubeInsertChapters: 'Insérer les chapitres YouTube',
		youtubeInsertingChapters: 'Génération des chapitres…',
		youtubeChaptersUnavailable: 'Aucun chapitre YouTube n\u2019a pu être généré pour cet export.',
		youtubeChaptersInsertFailed: 'Impossible de générer les chapitres YouTube.',
		youtubeVisibility: 'Visibilité',
		youtubePrivate: 'Privée',
		youtubeUnlisted: 'Non répertoriée',
		youtubePublic: 'Publique',
		youtubeAudience: 'Audience',
		youtubeNotMadeForKids: 'Non, elle n\u2019est pas conçue pour les enfants',
		youtubeMadeForKids: 'Oui, elle est conçue pour les enfants',
		youtubeSchedule: 'Programmer la publication',
		youtubeThumbnail: 'Miniature',
		youtubeThumbnailOptional: 'Fichier JPG ou PNG facultatif',
		youtubeBrowse: 'Parcourir',
		youtubeStagePreparing: 'Préparation de l\u2019envoi',
		youtubeStageUploading: 'Envoi de la vidéo',
		youtubeStageThumbnail: 'Envoi de la miniature',
		youtubeStageCompleted: 'Envoi terminé',
		youtubeOpenVideo: 'Ouvrir la vidéo sur YouTube',
		youtubeClose: 'Fermer',
		youtubeCancel: 'Annuler',
		youtubeUpload: 'Envoyer',
		youtubeNotConfigured: 'OAuth YouTube n\u2019est pas configuré dans cette version.',
		youtubeNotConnected: 'Connectez un compte YouTube avant l\u2019envoi.',
		youtubeOAuthTimeout: 'La connexion Google a expiré. Veuillez réessayer.',
		youtubeInvalidTitle: 'Le titre doit contenir entre 1 et 100 caractères.',
		youtubeInvalidDescription: 'La description ne peut pas dépasser 5 000 caractères.',
		youtubeInvalidVisibility: 'Sélectionnez une visibilité valide.',
		youtubeScheduleRequiresPrivate:
			'Une vidéo programmée doit rester privée jusqu\u2019à sa publication.',
		youtubeVideoNotFound: 'La vidéo exportée est introuvable.',
		youtubeThumbnailNotFound: 'La miniature sélectionnée est introuvable.',
		youtubeThumbnailTooLarge: 'La miniature ne peut pas dépasser 2 Mo.',
		youtubeInvalidThumbnail: 'La miniature doit être un fichier JPG ou PNG.'
	}
} as Translation;
