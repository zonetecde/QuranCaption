...
const fr = {
	...
	tour: {
		...
		stepOpenTutorialDesc:
			'Un projet tutoriel avec la sourate Al-Fatihah par Yasser Al-Dosari a été créé pour vous. Touchez sa carte pour l\u2019ouvrir et suivre le guide.',
		...
		hintClickTutorialCard: 'Touchez la carte du projet tutoriel pour continuer',
		hintHoverAndAdd: 'Touchez le bouton + de l\u2019élément de récitation pour continuer',
