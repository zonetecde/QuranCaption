...
const fr = {
	...
	batch: {
		...
		segmentationWbw: 'Conserver les timestamps mot à mot : {value}',
		segmentationRiwayah: 'Riwayah : {value}',
		segmentationPaddingSides: 'Marge : {left} ms avant · {right} ms après',
		enabled: 'Activés',
		disabled: 'Désactivés',
		...
		segmentationCloudSpacing:
			'Les chapitres avancent indépendamment dans les files d’alignement et de timing.',
		segmentationWaitingNextCloudRequest: 'En attente d’une place dans le batch',
		segmentationStagePreparing: 'Préparation de l’audio',
		segmentationStageUploading: 'Envoi de l’audio',
		segmentationStageQueuedAlignment: 'En attente d’alignement',
		segmentationStageQueuedGpu: 'En attente du GPU',
		segmentationStageQueuedCpu: 'En attente d’un worker CPU',
		segmentationStageSegmenting: 'Détection des limites',
		segmentationStageTranscribing: 'Reconnaissance de la récitation',
		segmentationStageMatching: 'Correspondance avec le texte coranique',
		segmentationStageBuilding: 'Construction des résultats',
		segmentationStageAlignmentComplete: 'Alignement terminé',
		segmentationStageQueuedTiming: 'Aligné, en attente du timing',
		segmentationStageTiming: 'Timing des mots',
		segmentationStageSplitting: 'Découpage des sous-titres',
		segmentationPipelineAligning: '{count} en alignement',
		segmentationPipelineTiming: '{count} en timing',
		segmentationPipelineWaitingTiming: '{count} en attente du timing',
		...
		aiSplitLongSubtitles: 'Découper les longs sous-titres avec l’IA',
		aiTrimTranslations: 'Trimmer les traductions avec l’IA',
		aiSplitMaxWordsPrompt: 'Nombre maximal de mots par sous-titre pour le découpage IA (1–30)',
		aiSplitMaxWordsInvalid: 'Saisissez un nombre entier compris entre 1 et 30.',
		aiBatchOperationSummary:
			'{completed} projet(s) terminé(s) · {skipped} ignoré(s) · {failed} échoué(s)',
	...
	editor: {
		...
		huggingFaceTokenLabel: 'Token de téléchargement des modèles locaux',
	...
	settings: {
		...
		shortcutAction: {
			...
			REFETCH_WBW_TIMESTAMPS: 'Recalculer les timestamps WBW',
			REMOVE_SUBTITLE_AT_CURSOR: 'Supprimer le clip au curseur',
		...
		shortcutActionDesc: {
			...
			REFETCH_WBW_TIMESTAMPS: 'Recalcule les timestamps mot à mot du sous-titre sous le curseur',
			REMOVE_SUBTITLE_AT_CURSOR: 'Supprime le sous-titre ou le clip de silence sous le curseur',
