...
const id = {
	...
	batch: {
		...
		segmentationWbw: 'Simpan stempel waktu per kata: {value}',
		segmentationRiwayah: 'Riwayah: {value}',
		segmentationPaddingSides: 'Padding: {left} md sebelum · {right} md sesudah',
		enabled: 'Aktif',
		disabled: 'Nonaktif',
		...
		segmentationCloudSpacing: 'Surah bergerak terpisah melalui antrean penyelarasan dan waktu.',
		segmentationWaitingNextCloudRequest: 'Menunggu slot batch yang tersedia',
		segmentationStagePreparing: 'Menyiapkan audio',
		segmentationStageUploading: 'Mengunggah audio',
		segmentationStageQueuedAlignment: 'Menunggu penyelarasan',
		segmentationStageQueuedGpu: 'Menunggu GPU',
		segmentationStageQueuedCpu: 'Menunggu worker CPU',
		segmentationStageSegmenting: 'Mendeteksi batas bacaan',
		segmentationStageTranscribing: 'Mengenali bacaan',
		segmentationStageMatching: 'Mencocokkan teks Al-Qur’an',
		segmentationStageBuilding: 'Membangun hasil penyelarasan',
		segmentationStageAlignmentComplete: 'Penyelarasan selesai',
		segmentationStageQueuedTiming: 'Selaras, menunggu waktu',
		segmentationStageTiming: 'Mengatur waktu kata',
		segmentationStageSplitting: 'Membagi subtitle',
		segmentationPipelineAligning: '{count} sedang diselaraskan',
		segmentationPipelineTiming: '{count} sedang diatur waktunya',
		segmentationPipelineWaitingTiming: '{count} menunggu waktu',
		...
		aiSplitLongSubtitles: 'Pisahkan Subtitel Panjang dengan AI',
		aiTrimTranslations: 'Pangkas Terjemahan dengan AI',
		aiSplitMaxWordsPrompt: 'Maksimum kata per subtitel untuk pemisahan AI (1–30)',
		aiSplitMaxWordsInvalid: 'Masukkan bilangan bulat antara 1 dan 30.',
		aiBatchOperationSummary: '{completed} proyek selesai · {skipped} dilewati · {failed} gagal',
	...
	settings: {
		...
		shortcutAction: {
			...
			REFETCH_WBW_TIMESTAMPS: 'Ambil ulang timestamp WBW',
			REMOVE_SUBTITLE_AT_CURSOR: 'Hapus klip di kursor',
		...
		shortcutActionDesc: {
			...
			REFETCH_WBW_TIMESTAMPS: 'Menghitung ulang timestamp per kata untuk subtitle di bawah kursor',
			REMOVE_SUBTITLE_AT_CURSOR: 'Menghapus subtitle atau klip hening di bawah kursor',
	...
	exporterMonitor: {
		...
		openExportFolder: 'Buka folder ekspor',
		failedToOpenExportFolder: 'Folder ekspor tidak dapat dibuka',
