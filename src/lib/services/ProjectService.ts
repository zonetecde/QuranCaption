...
export class ProjectService {
	...
	/**
	 * Exporte un projet et tous ses assets locaux dans un fichier `.minbar`.
	 * @param {Project} project Projet à empaqueter.
	 * @param {string} destination Chemin du fichier `.minbar` à créer.
	...
	/**
	 * Importe un paquet `.minbar`, extrait ses assets et réécrit leurs chemins dans le projet.
	 * @param {string} filePath Chemin du paquet `.minbar`.
